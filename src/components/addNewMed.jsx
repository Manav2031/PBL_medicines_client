...
export default function AddMed(){
    ...
    return(
      ...
      <Form.Group className="mb-3" controlId="formBasicEmail">
        ...
        <Form.Control type="number" placeholder="Enter quantity" className="fish" />
      </Form.Group>

      <Form.Group className="mb-3" controlId="formBasicEmail">
        <Form.Label>Description</Form.Label>
        <Form.Control type="text" placeholder="Enter description of the text" className="lish" />
      </Form.Group>

      <Form.Group className="mb-3" controlId="formBasicEmail">
        <Form.Label>Expiration date</Form.Label>
        <Form.Control type="date" placeholder="Enter date of expiry." className="pish" />
      </Form.Group>
